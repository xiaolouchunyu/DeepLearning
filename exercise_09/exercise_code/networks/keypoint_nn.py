...
class KeypointModel(pl.LightningModule):
    ...
    def __init__(self, hparams):
       ...
       #     nn.Conv2d(1, 2, kernel_size=kernel_size, padding=padding, stride=stride, dilation=dilation),
       #     nn.ReLU()
           # nn.MaxPool2d(2, 2),
           # nn.Dropout2d(p=0.5),
           # nn.Conv2d(24*24, input_shape=(48, 48, 1), kernel_size=kernel_size, padding=padding, stride=stride, dilation=dilation),
           # nn.ReLU(),
            #nn.MaxPool2d(2, 2),
            #nn.Dropout2d(p=0.5),
            #nn.Conv2d(12*12, input_shape=(24, 24, 1), kernel_size=kernel_size, padding=padding, stride=stride, dilation=dilation),
           # nn.ReLU(),
           # nn.MaxPool2d(2, 2),
           # nn.Dropout2d(p=0.5),
           # nn.Conv2d(30, input_shape=(12, 12, 1), kernel_size=kernel_size, padding=padding, stride=stride, dilation=dilation),
           # nn.ReLU(),
           # nn.MaxPool2d(2, 2),
           # nn.ReLU()
        #)
