...
class Classifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        #optim = torch.optim.Adam(self.parameters(),lr=0.005,betas=(0.9,0.999),eps=1e-08,weight_decay=1e-5,amsgrad=False)
      
        optim = torch.optim.Adam(self.parameters(), lr=0.005, weight_decay=1e-5)
